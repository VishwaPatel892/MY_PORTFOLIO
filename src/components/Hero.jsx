...
const Hero = () => {
    return (
        <section id="home" className="min-h-screen flex flex-col justify-center items-center relative px-4 overflow-hidden pt-10 pb-20">
            ...
            >
                {/* Massive Name - Added little gapping as requested */}
                <div className="text-center w-full leading-[0.95] mb-12 select-none pointer-events-none mt-10 md:mt-20 flex flex-col items-center justify-center">
                    <motion.h1 
                        initial={{ opacity: 0, scale: 0.95 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
                        className="text-[16vw] lg:text-[14vw] font-black tracking-tighter text-white uppercase m-0 w-full"
                    >
                        VISHWA
                    </motion.h1>
                    <motion.h1 
                ...
                <motion.div 
                    ...
                    className="text-center mt-4 md:mt-12 flex flex-col items-center z-10"
                >
                    ...
                    <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white font-serif italic drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">
